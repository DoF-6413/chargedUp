...
public class ScoreConeLow extends SequentialCommandGroup {
  ...
  public ScoreConeLow(ArmPIDSubsystem arm, TelescoperSubsystem telescoper, EndEffectorSubsystem NEfctr, DrivetrainSubsystem drive) {
    ...
    addCommands(
      ...
      new TelescoperPID(telescoper, TelescoperConstants.kGroundCone),
      Commands.runOnce(
        () -> {
          arm.setGoal(Units.degreesToRadians(-ArmConstants.kfloorCube)+ArmConstants.kArmOffsetRads);
          arm.enable();
