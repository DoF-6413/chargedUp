...
public class DoubleScore extends SequentialCommandGroup {
  ...
  public DoubleScore(ArmPIDSubsystem arm, TelescoperSubsystem telescoper, EndEffectorSubsystem NEfctr, DrivetrainSubsystem drive, WristSubsystem wrist) {
    HashMap<String, Command> eventDoubleScoreConeMap = new HashMap<>();
    eventDoubleScoreConeMap.put("score", new BackingOutArm(arm, telescoper, NEfctr));
    eventDoubleScoreConeMap.put("pickup", new PositionPickUp(telescoper, arm, NEfctr));
    eventDoubleScoreConeMap.put("score2", new ThrowCubes(arm, NEfctr, telescoper, wrist));
