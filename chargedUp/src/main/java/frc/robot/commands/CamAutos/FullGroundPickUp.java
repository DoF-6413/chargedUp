...
public class FullGroundPickUp extends SequentialCommandGroup {
  /** Creates a new FullGroundPickUp. */
  public FullGroundPickUp(TelescoperSubsystem telscoper, ArmPIDSubsystem arm, EndEffectorSubsystem NEfector) {
