...
public class ThrowCubes extends SequentialCommandGroup {
  ...
  public ThrowCubes(ArmPIDSubsystem arm, EndEffectorSubsystem NEfector, TelescoperPIDSubsystem telescoper, WristSubsystem wrist) {
    ...
    addCommands(
      ...
      Commands.runOnce(
        ...
        new TelescoperWrapper(telescoper, 53),
